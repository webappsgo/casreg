...
func ScanTag(cfg interface{}, db interface{}, storage interface{}) http.HandlerFunc { return notImplemented }
...
func AdminSystemStats(cfg interface{}, db interface{}, storage interface{}) http.HandlerFunc { return notImplemented }
...
func GetBlobUploadStatus(db interface{}, storage interface{}) http.HandlerFunc { return notImplemented }
func UploadBlobChunk(db interface{}, storage interface{}) http.HandlerFunc { return notImplemented }
func CompleteBlobUpload(db interface{}, storage interface{}) http.HandlerFunc { return notImplemented }
...
func MetricsHandler(cfg interface{}, db interface{}, storage interface{}) http.HandlerFunc { return notImplemented }
